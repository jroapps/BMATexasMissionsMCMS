...
const ManageRetreatRegistrations: React.FC = () => {
    ...
    useEffect(() => {
        const registrationsRef = firestore.collection('RetreatRegistrations');
    ...
    const deleteRegistration = async () => {
        try {
            const registrationsRef = firestore.collection('RetreatRegistrations').doc(deleteId);
            let ans = window.confirm("Are you sure you want to delete the retreat registration?");
            if (ans) {
    ...
    const updateRegistration = async () => {
        try {
            ...
            const registrationsRef = firestore.collection('RetreatRegistrations').doc(id);
            let ans = window.confirm("Are you sure you want to update this retreat registration?");
            if (ans) {
                setFilled(false);
                ...
                <IonPage id="main">
                    <IonHeader>
                        <IonToolbar color="primary">
                            ...
                            <IonTitle>Manage Retreat Registrations</IonTitle>
                        </IonToolbar>
                    </IonHeader>
                                ...
                                <IonCol>
                                    <IonList className="ion-padding">
                                        ...
                                        <IonItem key={firstHalf.id}><br/>
                                            ...
                                            Registered Retreat ID: {firstHalf.retreatId}<br/><br/>
                                ...
                                <IonCol>
                                    <IonList className="ion-padding">
                                        ...
                                        <IonItem key={secondHalf.id}><br/>
                                            ...
                                            Registered Retreat ID: {secondHalf.retreatId}<br/><br/>
...
export default ManageRetreatRegistrations;
